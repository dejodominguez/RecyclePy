...
require_once("include/gestionpesosresiduos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.GestionPesosResiduos" );
