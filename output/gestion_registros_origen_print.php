...
require_once("include/gestion_registros_origen_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.gestion_registros_origen" );
