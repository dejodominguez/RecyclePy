...
class ConnectionManager
{
	...
	{
		return $this->byId( "RealEstate_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 4;
		$data["connId"] = "RealEstate_at_localhost";
		$data["connName"] = "RecyclePy at localhost";
		$data["connStringType"] = "postgre";
		$data["connectionString"] = "postgre;localhost;postgres;3846173;;RecyclePy;;1;5433"; //currently unused

		$this->_connectionsIdByName["RecyclePy at localhost"] = "RealEstate_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "postgres";
		$data["ODBCPWD"] = "3846173";
		$data["leftWrap"] = "\"";
		$data["rightWrap"] = "\"";
		...
		$data["connInfo"][2] = "3846173";
		$data["connInfo"][3] = " port=5433";
		$data["connInfo"][4] = "RecyclePy";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "Driver={PostgreSQL Unicode};Server=localhost;Database=RecyclePy;Uid=postgres;Pwd=3846173;";
		// encription set
		...
		$connectionsData["RealEstate_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["public.Recicladores"] = "RealEstate_at_localhost";
		$connectionsIds["public.GestionPesosResiduos"] = "RealEstate_at_localhost";
		$connectionsIds["public.Residuos"] = "RealEstate_at_localhost";
		$connectionsIds["public.Usuarios"] = "RealEstate_at_localhost";
		$connectionsIds["public.MedTipoOrigen"] = "RealEstate_at_localhost";
		$connectionsIds["public.EmpresasRecicladores"] = "RealEstate_at_localhost";
		$connectionsIds["public.DetalleVentas"] = "RealEstate_at_localhost";
		$connectionsIds["public.Ventas"] = "RealEstate_at_localhost";
		$connectionsIds["public.GestionPesosResiduosDetVen"] = "RealEstate_at_localhost";
		$connectionsIds["public.Barrios"] = "RealEstate_at_localhost";
		$connectionsIds["public.GestionRegistrosOrigen"] = "RealEstate_at_localhost";
		$connectionsIds["public.GestionRegistrosOrigen Report"] = "RealEstate_at_localhost";
