...
require_once("include/gestionpesosresiduos1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.GestionPesosResiduos1" );
