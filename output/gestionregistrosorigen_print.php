...
require_once("include/gestionregistrosorigen_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.GestionRegistrosOrigen" );
