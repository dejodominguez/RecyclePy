...
require_once("include/public_usuariosview_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.UsuariosView" );
