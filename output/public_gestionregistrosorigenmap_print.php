...
require_once("include/public_gestionregistrosorigenmap_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.GestionRegistrosOrigenMap" );
