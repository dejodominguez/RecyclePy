...
require_once("include/public_gesorigenusuarios_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.GesOrigenUsuarios" );
