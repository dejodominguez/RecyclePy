...
class ListPage extends RunnerPage
{
	...
	{
		if( postvalue("pageType") == "register" && postvalue("table") == "public.usuarios" )
			return new ProjectSettings( "public.usuarios", PAGE_REGISTER, "", GLOBAL_PAGES);
