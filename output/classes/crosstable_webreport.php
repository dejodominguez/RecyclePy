...
class CrossTableWebReport
{
	...
	{			
		$isDB = false;
		if("public.MedTipoOrigen" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.GestionRegistrosOrigen" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.GestionRegistrosOrigen" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.barrios" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.tipos_usuarios" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.residuos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.recicladores" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.usuarios" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.empresas_recicladoras" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.gestion_pesos_residuos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.ventas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.detalles_ventas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("public.gestion_pesos_residuos" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
