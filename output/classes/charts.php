...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("public.Recicladores" == $this->chrt_array['tables'][0])
			return true;
		if("public.GestionPesosResiduos" == $this->chrt_array['tables'][0])
			return true;
		if("public.Residuos" == $this->chrt_array['tables'][0])
			return true;
		if("public.Usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("public.MedTipoOrigen" == $this->chrt_array['tables'][0])
			return true;
		if("public.EmpresasRecicladores" == $this->chrt_array['tables'][0])
			return true;
		if("public.DetalleVentas" == $this->chrt_array['tables'][0])
			return true;
		...
		if("public.Barrios" == $this->chrt_array['tables'][0])
			return true;
		if("public.GestionRegistrosOrigen" == $this->chrt_array['tables'][0])
			return true;
		if("public.GestionRegistrosOrigen" == $this->chrt_array['tables'][0])
			return true;
		return false;
