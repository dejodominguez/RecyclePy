...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("public.barrios" == $this->chrt_array['tables'][0])
			return true;
		if("public.tipos_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("public.residuos" == $this->chrt_array['tables'][0])
			return true;
		if("public.recicladores" == $this->chrt_array['tables'][0])
			return true;
		if("public.usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("public.empresas_recicladoras" == $this->chrt_array['tables'][0])
			return true;
		if("public.gestion_pesos_residuos" == $this->chrt_array['tables'][0])
			return true;
		if("public.ventas" == $this->chrt_array['tables'][0])
			return true;
		if("public.detalles_ventas" == $this->chrt_array['tables'][0])
			return true;
		if("public.gestion_pesos_residuos" == $this->chrt_array['tables'][0])
			return true;
		if("public.gestion_registros_origen" == $this->chrt_array['tables'][0])
			return true;
		if("public.med_tipo_origen" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
