...
$pageMask[$table] = $mask;
$tables[$table] = array("recicladores", " " . "Recicladores");
...
$pageMask[$table] = $mask;
$tables[$table] = array("gestionpesosresiduos", " " . "Gestion Pesos Residuos");
...
$pageMask[$table] = $mask;
$tables[$table] = array("residuos", " " . "Residuos");
...
$pageMask[$table] = $mask;
$tables[$table] = array("gestionregistrosorigen", " " . "Gestion Registros Origen");
$table = "public.MedTipoOrigen";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("medtipoorigen", " " . "Med Tipo Origen");
