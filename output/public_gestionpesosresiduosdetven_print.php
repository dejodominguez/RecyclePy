...
require_once("include/public_gestionpesosresiduosdetven_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.GestionPesosResiduosDetVen" );
