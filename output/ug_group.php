...
$nonAdminTablesArr[] = "public.Recicladores";
$nonAdminTablesArr[] = "public.GestionPesosResiduos";
$nonAdminTablesArr[] = "public.Residuos";
$nonAdminTablesArr[] = "public.Usuarios";
$nonAdminTablesArr[] = "public.GestionRegistrosOrigen";
$nonAdminTablesArr[] = "public.MedTipoOrigen";
...
$wGroupTableName = $ug_connection->addTableWrappers( "public.recyclepy_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "public.recyclepy_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue_number("id"));
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "public.recyclepy_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue_number("id"));
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "public.recyclepy_ugrights" );
