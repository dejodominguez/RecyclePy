...
require_once("include/public_detalles_ventas1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.detalles_ventas" );
