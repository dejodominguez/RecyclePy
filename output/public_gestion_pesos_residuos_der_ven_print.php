...
require_once("include/public_gestion_pesos_residuos_der_ven_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.gestion_pesos_residuos_der_ven" );
