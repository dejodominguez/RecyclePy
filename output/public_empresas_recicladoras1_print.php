...
require_once("include/public_empresas_recicladoras1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.empresas_recicladoras" );
