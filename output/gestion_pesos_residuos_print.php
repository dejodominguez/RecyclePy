...
require_once("include/gestion_pesos_residuos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.gestion_pesos_residuos" );
