...
require_once("include/public_gestionpesosresiduosderven_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.GestionPesosResiduosDerVen" );
