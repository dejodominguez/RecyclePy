...
require_once("include/recyclepy_users_separadores_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.RecyclePy_users_separadores" );
